...
"""
mutable struct MtlDoubleHT{K,V}
...
"""
    MtlDoubleHT{K,V}(n_buckets::Int) -> MtlDoubleHT{K,V}
...
"""
    upsert!(status::MtlVector{UInt8}, table::MtlDoubleHT{K,V}, keys::MtlVector{K}, vals::MtlVector{V})
...
"""
    upsert!(table::MtlDoubleHT{K,V}, keys::MtlVector{K}, vals::MtlVector{V}) -> MtlVector{UInt8}
...
"""
    upsert!(table::MtlDoubleHT{K,V}, keys::Vector{K}, vals::Vector{V}) -> Vector{UInt8}
